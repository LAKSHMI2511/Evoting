...
$fileNamelist[$i]=md5(uniqid());
$target_path = $target_path . $fileNamelist[$i] . "." . $ext[count($ext) - 1];     // Set the target path with a new name of image.
...
echo implode($error);
    ...
    if(sizeof($error)==0)
        ...
        for ($i = 0; $i < count($_POST['cname'])-1; $i++) {
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                                                        ...
                                                        <li class="act"><a href="voters.php">Add Election</a></li>
						</ul>
					</div><!-- /.navbar-collapse -->
		...
		<div class="container">
			...
			<div class="grid_3 grid_4">
				...
				<table class="table">
					...
					<tbody>
						<tr>
                                                    <td><input type="text" class="cname" style="border: none; border-bottom: 2px solid steelblue;width: 100%;height:50px" name="cname[]" required /></td>
...
<div class="bs-docs-example">
				<table class="table">
					<tbody>
						<tr>
							<td><input type="text" style="border: none; border-bottom: 2px solid steelblue;width: 100%;height:50px" name="cname[]"  class="cname" arequire /></td>
							<!--td><input type="text" style="border: none; border-bottom: 2px solid steelblue;width: 100%;height:50px" name="party[]" /></td-->
