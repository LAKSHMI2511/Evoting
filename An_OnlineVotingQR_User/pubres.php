...
$("#subtype").append('<option >CHOOSE Constituency</option>');
    ...
    etype=$("#etype").val();
    stype=$("#subtype").val();
  $.getJSON("./fetchElectionResPubList.php?etype="+etype+"&subtype="+stype , function(data) {
    ...
    $.each(data, function() {
        ...
        $.each(this, function(k , v) {
            ...
            if(v.toString()=="No Records Found"){
                nodata=true;
            }
        })        
         var cell = tbl_row.insertCell();
         ...
         b.setAttribute('value','Publish');
         b.addEventListener ("click", function() {
             console.log($(this).parent().parent());
             _tr=$(this).parent().parent();
             ename=$(_tr[0]).children()[0];
             ename=$(ename).text();
             etype=$(_tr[0]).children()[1];
             etype=$(etype).text();
             edate=$(_tr[0]).children()[2];
             edate=$(edate).text();
             estype=$(_tr[0]).children()[3];
             estype=$(estype).text();
              updateResult(ename,etype,edate,estype,_tr);
...
function updateResult(elnam,eltype,eldate,elsubtype,_tr){
 $.getJSON("./publishRes.php?etype="+eltype+"&subtype="+elsubtype+"&edate="+eldate+"&ename="+elnam , function(data) {
    console.log(data);
    $(_tr).remove();       
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li><a href="adminmain.php">Admin</a></li>
                                                        ...
                                                        <li ><a href="voters.php">Add Voter</a></li>
                                                        <li class="act"><a href="pubres.php">Publish Result</a></li>
	...
	<div class="typo">
		<div class="container">
			...
			<div class="grid_3 grid_4">
				<h3 class="hdg">Publish Election Result</h3>
