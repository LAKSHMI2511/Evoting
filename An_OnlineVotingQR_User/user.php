...
if(isset($_POST['submit'])){
    ...
    if(sizeof($error)==0){
        ...
        $sql = "select * from voterinfo where vname='".$name."' and password='".$pass."'";
				...
				<div class="bs-example">
					...
					<table class="table">
						<tbody>
							...
							<tr>
                                                            <td><h4 id="h4.-bootstrap-heading"><b>User Name</b></h4><input type="text" name="name" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px" /></td>
								
							</tr>
								<tr>
                                                                    <td><h4 id="h4.-bootstrap-heading"><b>User Password</b></h4><input type="password" name="password" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px"/></td>
