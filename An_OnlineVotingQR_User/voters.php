					...
					<table class="table">
						...
						<tr>
							...
							<tr>
								...
								<tr>
                                                            <td><h4 id="h4.-bootstrap-heading"><b>Voter Password</b></h4><input type="text" name="password"  id="passwrd" style="border: none; border-bottom: 2px solid steelblue;width: 80%;height:50px"  value="<?php echo isset($password)? $password : "" ?>"/></td>
							</tr>
							<tr>
