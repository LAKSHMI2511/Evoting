...
$error[$j]= '<span id="error">Finger Print Empty!</span><br/><br/>';
}
}
$fpbasepath="./fpimages/";
$fpath=$fpbasepath.md5(uniqid()). ".png";
    file_put_contents($fpath, base64_decode($fpstr));


    if(sizeof($error)==0)
        {
       
          $sql="insert into voterinfo (vimage,vaadhar,vname,vid,dob,area)"
              . "values('".$fileNamelist[0]."','".$aadhar."','".$name."','".$id."','".$dob."','$area')";
...
function processResult(str){
  ...
  $xml = $( xmlDoc );
  console.log($xml);
$child = $xml[0].childNodes[0];
$("#vaadhar").val($child.getAttribute('uid'));
    }
        var flag =0;
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							<li><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
                                                        ...
                                                        <li class="act"><a href="voters.php">Add Voters</a></li>
                                                        <li ><a href="election.php">Create Election</a></li>
						</ul>
					</div><!-- /.navbar-collapse -->	
			...
			<div class="grid_3 grid_4">
				...
				<div class="bs-example" style="width:50%;float:left">
					<table class="table">
						...
						<tr>
                                                    <td><h4 id="h4.-bootstrap-heading"><b>Voter Image</b></h4><br/><input type="file" name="vimage[]" onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px" /></td>
					    </tr>
							<tr>
                                                            <td><h4 id="h4.-bootstrap-heading"><b>Voter Adhar Number</b></h4><input type="text" name="vaadhar"  id="vaadhar" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px" value="<?php echo  isset($aadhar) ?  $aadhar:"" ?>"/></td>
							</tr>
							<tr>
                                                            <td><h4 id="h4.-bootstrap-heading"><b>Voter Name</b></h4><input type="text" name="vname" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px"  value="<?php echo isset($name)? $name : "" ?>"/></td>
							</tr>
							
							<tr>
                                                                    <td><h4 id="h4.-bootstrap-heading"><b>Voter Id</b></h4><input type="text" name="vid" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px" value="<?php echo isset($id)?$id:"" ?>"/></td>
							</tr>
							<tr>
                                                                    <td><h4 id="h4.-bootstrap-heading"><b>Area</b></h4>
                                                                         <select name="area" id="subtype" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px" required>
...
echo  "<option value=\"".$row['area']."\">".$row['area']."</option>";
							...
							<tr>
                                                            <td><h4 id="h4.-bootstrap-heading"><b>Voter Date Of Birth</h4><input type="date" name="dob"  id="dob" data-date-inline-picker="true" style="border: none; border-bottom: 2px solid steelblue;width: 40%;height:50px"  value="<?php echo isset($dob)?$dob:"" ?>"/></td>
							</tr>
        ...
        <video id="preview"  style="width:200px;height:200px"></video>
					...
					<img id="blah" alt="your photo here" src="./images/no-image.webp" width="200" height="200" />
			...
			<input type="button" id="btnCapture" value="Capture" class=" capturebuttonpadding btn btn-primary btn-lg submit_buttom_padding" onclick="return Capture()" style="margin-top:20px"/>		
			</div>	
                        </div>
